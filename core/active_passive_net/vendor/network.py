...
def build_active_passive_network(roles, dual_roles, fillers, tree_shape):
    ...
    passive_branch_inputs, passive_branch_output = extract_semantic_tree_from_passive_voice_branch()
    active_branch_inputs, active_branch_output = extract_semantic_tree_from_active_voice_branch()
